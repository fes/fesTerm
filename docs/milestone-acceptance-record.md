...
- [ ] Stable Windows and Linux snapshot results and controlled diff artifacts (D/P3). The 2026-08-12 direct Windows run found every committed Windows snapshot invalid after the blue-graphite theme change; review and deliberate baseline replacement are required.
