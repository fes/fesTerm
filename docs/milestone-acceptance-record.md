...
**Candidate SHA:** `bcfd7a7` (`main`, 2026-08-10; evidence record refreshed
after the manually operated VM-lab P4 evidence collection run)
...
- [ ] Cross-platform CI evidence for the native-window self-smoke and independently driven platform focus/accessibility proof (E/P4). A manually operated VM lab produced first cross-platform evidence on 2026-08-10 (macOS pass; Linux and Windows fail/blocked — see [#32](https://github.com/fes/fesTerm/issues/32)-[#36](https://github.com/fes/fesTerm/issues/36)), but this does not substitute for CI evidence.
