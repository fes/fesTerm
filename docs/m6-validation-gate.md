...
| D — Visual snapshot layer | [#7](https://github.com/fes/fesTerm/issues/7) | In progress; Windows baselines require deliberate review and replacement after the blue-graphite theme change invalidated every reviewed Windows snapshot in the direct 2026-08-12 run at `99d028d`. Linux CI confirmation remains pending. |
