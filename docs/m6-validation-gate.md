...
| D — Visual snapshot layer | [#7](https://github.com/fes/fesTerm/issues/7) | In progress; the blue-graphite Windows baseline replacement was visually reviewed and passes at `8a3d331`. Linux CI confirmation remains pending. |
