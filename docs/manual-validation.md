...
| CP-05 | Review appearance controls, update behavior, file-drop path insertion, and terminal search when each capability lands. | Deferred by capability | Add a focused scenario before implementation closes |
