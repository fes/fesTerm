...
generation references them and are pruned afterward. The first transition from
an older release can still require terminating its directly installed daemon;
subsequent compatible updates no longer do.
