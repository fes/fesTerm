...
| Emoji and fallback | Preserve cell layout across fallback fonts | passing | All 3,773 fully-qualified Unicode 15.1 emoji are tested for streamed two-cell geometry, color classification/rasterization, and owned monochrome scalar coverage; bounded caches; reviewed Windows/Linux snapshots; native emoji smoke verifies geometry and color-texture submission |
